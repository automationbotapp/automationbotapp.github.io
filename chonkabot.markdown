...
| !pickemon | Tell the chatter their randomly generated Pokémon for the day (global Pokédex). | curlieqWave @${user}, your Pokémon for today is: ${pokemonName}! Congrats! curlieqEspeon | Viewer | No |
| !defender | Say how many days since Pokémon Unite last released a defender. | It's been over ${days} days since Unite added a new defender... just sayin' curlieqMurder | Viewer | No |
| !unitespin | Choose a random Pokémon from the Pokémon Unite roster for the chatter. | @${user} Your random Unite Pokémon is ... *drumroll* ... ${pokemon}! GLHF! curlieqMonka | Viewer | No |
| !pdb | Tell the chatter basic information about a specific Pokémon from the Pokédex. | @${user} Here's what I know about [#${pokemonId}] ${pokemonName} ... ${pokemonData} | Viewer | No |
| !tdb | Tell the chatter type information about a specific Pokémon Type from the Pokédex. | @${user} ${typeName} types are... weak to: ${weakTo}; and strong against: ${strongAgainst} | Viewer | No |
...
| hobbiesville |  | Hey, have you heard of Hobbiesville?! You can purchase a variety of video game collectibles including Pokémon Cards and you can also get 5% off of your purchase when you use code: CURLIE | Viewer | 'Yes' |
| mentalhealth |  | If you're struggling with your mental health, it's important to seek help from professionals. Check this list of global helplines: http://bit.ly/GlobalHotlines ❤ | Viewer | 'Yes' |
...
| joycons |  | Curlie plays with split joycons as it's easier for her to do Stream Things™️  and she prefers them to the pro controllers! | Viewer | 'Yes' |
...
| psykey |  | my milfy queen psykey. i can’t talk bad about you. you go have fun and i hope you have a great rest of your day | Viewer | 'Yes' |
| scolded |  | It's egotistical to think that calling jungle first entitles you to jungle | Viewer | 'Yes' |
| curlie |  | my canadian queen curlie. i can’t talk bad about you. you go have fun and i hope you have a great rest of your day | Viewer | 'Yes' |
...
| team |  | Curlie’s nuzlocke team is: Absol, Eldegoss, Scizor, Mamoswine, Sylveon, Trevenant, Venusaur, and Mr. Mime | Viewer | 'Yes' |
...
| nickname |  | Subscribe or gift a sub to have your name put on a wheel. Everytime Curlie catches a Pokémon she will spin the wheel and whoever it lands on is the person the Pokémon will be named after. If your name gets chosen multiple times, you may suggest PG names. *This does not include starter, legendary, or mythicals* | Viewer | 'Yes' |
...
| incentive |  | Our Incentives are: $10 Pick Curlie's Pokémon; $20 Open booster pack; $30 Pick the team comp; $50 Open a present! Also, every first time donator gets an energy card "ornament" on the tree with their name on it! | Viewer | 'Yes' |
